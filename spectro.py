...
Last change: Wed Nov  7 23:10:36 2018
...
class LMS:
    ...
    def compute_snr(self, integration_time):
        ...
        # the mirror area in SimMETIS is only concerned with emission
        mirr_area = np.pi / 4 * np.sum(37.3**2 - 11.1**2) * u.m**2
...
if __name__ == '__main__':
    ...
    lms.transmission_emission(conditions='best', plot=(len(sys.argv) > 3))
